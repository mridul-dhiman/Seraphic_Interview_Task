...
class HalfWidthCardViewHolder(
    itemView: View,
    private val click: GiftCardRecyclerViewAdapter.ClickListener
) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
    private val minText = itemView.findViewById<TextView>(R.id.halfWidthTVMinText)
    private val priceText = itemView.findViewById<TextView>(R.id.halfWidthTVPrice)
    private val offText = itemView.findViewById<TextView>(R.id.halfWidthTVOff)
